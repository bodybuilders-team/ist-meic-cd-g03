...
plt.tight_layout()
plt.savefig(f"images/distribution/{traffic_file_tag}_boxplot.png")
plt.show()
plt.clf()
...
plt.tight_layout()
plt.savefig(f"images/distribution/{traffic_file_tag}_distribution.png")
plt.show()
plt.clf()
...
plt.tight_layout()
plt.savefig(f"images/distribution/{traffic_file_tag}_lag_plot.png")
plt.show()
plt.clf()
...
plt.tight_layout()
plt.savefig(f"images/distribution/{traffic_file_tag}_correlogram.png")
plt.show()
plt.clf()
