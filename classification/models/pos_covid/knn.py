...
if run_parameter_study:
    best_model, params = knn_study2(trnX, trnY, tstX, tstY, k_max=25, file_tag=pos_covid_file_tag)
    plt.tight_layout()
    plt.savefig(f"images/{pos_covid_file_tag}_knn_study{sample_tag}.png")
    plt.show()
