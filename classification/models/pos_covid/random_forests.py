...
plt.tight_layout()
plt.savefig(f"images/{pos_covid_file_tag}_rf_{eval_metric}_study.png")
plt.show()
plt.clf()
...
plt.tight_layout()
plt.savefig(f"images/{pos_covid_file_tag}_rf_{eval_metric}_vars_ranking.png")
plt.show()
plt.clf()
...
plt.savefig(f"images/{pos_covid_file_tag}_rf_{eval_metric}_overfitting.png")
plt.show()
plt.clf()
