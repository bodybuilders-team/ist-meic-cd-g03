...
# Relatively quick to run without sampling: < 10 minutes
run_sampling = True
...
if run_parameter_study:
    ...
    fig.tight_layout()
    fig.savefig(f"images/{pos_covid_file_tag}_dt_study{sample_tag}.png")
    fig.show()
...
if run_variables_importance:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{pos_covid_file_tag}_DT_{eval_metric}_best_tree{sample_tag}.png")
    plt.show()
    plt.clf()
    ...
    plt.tight_layout()
    plt.savefig(f"images/{pos_covid_file_tag}_dt_{eval_metric}_vars_ranking{sample_tag}.png")
    plt.show()
    plt.clf()
...
if run_overfitting_study:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{pos_covid_file_tag}_dt_{eval_metric}_overfitting{sample_tag}.png")
    plt.show()
    plt.clf()
