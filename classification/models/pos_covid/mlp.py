...
if run_parameter_study:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{pos_covid_file_tag}_mlp_{eval_metric}_study{sample_tag}.png")
    plt.show()
    plt.clf()
...
if run_overfitting_study:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{pos_covid_file_tag}_mlp_{eval_metric}_overfitting{sample_tag}.png")
    plt.show()
    plt.clf()
