...
if run_parameter_study:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{credit_score_file_tag}_gb_{eval_metric}_study{sample_tag}.png")
    plt.show()
    plt.clf()

# Best alternative: 1000 trees (d=2 and lr=0.1)
...
if run_variables_importance:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{credit_score_file_tag}_gb_{eval_metric}_vars_ranking{sample_tag}.png")
    plt.show()
    plt.clf()
...
if run_overfitting_study:
    ...
    plt.tight_layout()
    plt.savefig(f"images/{credit_score_file_tag}_gb_{eval_metric}_overfitting{sample_tag}.png")
    plt.show()
    plt.clf()
