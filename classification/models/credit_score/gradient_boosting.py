...
plt.tight_layout()
plt.savefig(f"images/{credit_score_file_tag}_gb_{eval_metric}_study.png")
plt.show()
plt.clf()
...
plt.tight_layout()
plt.savefig(f"images/{credit_score_file_tag}_gb_{eval_metric}_vars_ranking.png")
plt.show()
plt.clf()
...
plt.tight_layout()
plt.savefig(f"images/{credit_score_file_tag}_gb_{eval_metric}_overfitting.png")
plt.show()
plt.clf()
