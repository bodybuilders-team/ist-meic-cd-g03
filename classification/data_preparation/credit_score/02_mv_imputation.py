...
data_frame.to_csv(f"../../data/pos_covid/processed_data/{credit_score_file_tag}_imputed_mv_approach1.csv", index=False)
print("Saved to file.")
...
print("Saving to file...")
data_frame.to_csv(f"../../data/pos_covid/processed_data/{credit_score_file_tag}_imputed_mv_approach2.csv", index=False)
print("Saved to file.")
