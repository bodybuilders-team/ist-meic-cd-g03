...
df_zscore.to_csv(f"../../data/pos_covid/processed_data/{pos_covid_file_tag}_scaled_zscore.csv", index="id")
...
df_minmax.to_csv(f"../../data/pos_covid/processed_data/{pos_covid_file_tag}_scaled_minmax.csv", index="id")
