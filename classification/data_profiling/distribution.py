...
#     plt.tight_layout()
#     plt.savefig(f"images/distribution/{pos_covid_file_tag}_global_boxplot.png")
#     plt.show()
#     plt.clf()
# else:
...
# #     plt.tight_layout()
# #     plt.savefig(f"images/distribution/{credit_score_file_tag}_global_boxplot.png")
# #     plt.show()
# #     plt.clf()
# # else:
# #     print("There are no numeric variables.")
...
#     plt.savefig(f"images/distribution/{pos_covid_file_tag}_single_boxplots.png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
#         i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
#     plt.savefig(f"images/distribution/{credit_score_file_tag}_single_boxplots.png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
#         percentage=False,
#     )
#     plt.savefig(f"images/distribution/{pos_covid_file_tag}_outliers_standard.png")
#     plt.show()
# else:
#     print("There are no numeric variables.")
#
...
#     plt.xticks(rotation=90)
#     plt.tight_layout()
#     plt.savefig(f"images/distribution/{credit_score_file_tag}_outliers_standard.png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
#         i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
#     plt.tight_layout()
#     plt.savefig(f"images/distribution/{pos_covid_file_tag}_single_histograms_numeric.png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
#         i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
#     plt.tight_layout()
#     plt.savefig(f"images/distribution/{credit_score_file_tag}_single_histograms_numeric.png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
#         i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
#     plt.tight_layout()
#     plt.savefig(f"images/distribution/{pos_covid_file_tag}_histogram_numeric_distribution.png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
#         i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
#     plt.tight_layout()
#     plt.savefig(f"images/distribution/{credit_score_file_tag} .png")
#     plt.show()
#     plt.clf()
# else:
#     print("There are no numeric variables.")
...
if pos_covid_symbolic:
    ...
    for n in range(len(pos_covid_symbolic)):
        ...
        i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
    plt.savefig(f"images/distribution/{pos_covid_file_tag}_histograms_symbolic.png")
    plt.tight_layout()
    plt.show()
else:
...
if credit_score_symbolic:
    ...
    for n in range(len(credit_score_symbolic)):
        ...
        i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
    plt.savefig(f"images/distribution/{credit_score_file_tag}_histograms_symbolic.png")
    plt.tight_layout()
    plt.show()
else:
    print("There are no symbolic variables.")
...
plt.savefig(f"images/{pos_covid_file_tag}_class_distribution.png")
plt.tight_layout()
plt.show()
...
plt.savefig(f"images/{credit_score_file_tag}_class_distribution.png")
plt.tight_layout()
plt.show()
